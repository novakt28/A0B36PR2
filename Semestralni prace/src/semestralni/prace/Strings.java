...
public class Strings { //List of (almost) all Strings used in game
    ...
    public static final String newGame = "Main Menu";
    ...
    public static final String start = "Ready";
    ...
    public static final String waitForOpponent = "Wait for opponent to shot.";
    public static final String yourTurn = "It's your turn.";
